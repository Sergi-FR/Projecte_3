...
public class CursCompeticio extends Curs {
    ...
    public ArrayList<CursCompeticio> consultaCursCompeticioBD() throws SQLException {
        ...
        // Demanem el DNI
        String consultaColectius = "SELECT C.ID, C.nomMonitor, C.data_curs, CX.data_fi ,COM.nivell_curs, COM.hora_inici, COM.hora_final, COM.preu FROM cursos C, competicio COM, competeix CX WHERE C.ID = COM.ID_comp and CX.ID_curs =  COM.ID_comp";
        ...
        while (rs.next()) {
            ...
            colectiu.setData_fi(Date.valueOf(rs.getString("data_fi")).toLocalDate());
